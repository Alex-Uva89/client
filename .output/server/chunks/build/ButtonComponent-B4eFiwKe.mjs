...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-6aaef089>`);
  if (!$props.isLink) {
...
const ButtonComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-6aaef089"]]);

export { ButtonComponent as B };
//# sourceMappingURL=ButtonComponent-B4eFiwKe.mjs.map
