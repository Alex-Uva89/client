...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-1497b166>`);
  _push(ssrRenderComponent(_component_HeaderDefault, { title: "Checkout" }, null, _parent));
  _push(`<form class="checkout-form" aria-labelledby="formTitle" data-v-1497b166><div class="form-container" data-v-1497b166><div class="form-group" data-v-1497b166><label for="fullName" aria-label="Nome e Cognome" data-v-1497b166>Nome e Cognome*</label><img${ssrRenderAttr("src", _imports_0)} alt="icona nome e cognome" data-v-1497b166><input${ssrRenderAttr("value", $data.form.fullName)} type="text" id="fullName" placeholder="Nome e Cognome" required aria-required="true" aria-describedby="fullNameHelp" data-v-1497b166><small id="fullNameHelp" data-v-1497b166>Inserisci il tuo nome completo</small></div><div class="form-group" data-v-1497b166><label for="address" aria-label="Indirizzo di Consegna" data-v-1497b166>Indirizzo di Consegna*</label><img${ssrRenderAttr("src", _imports_1)} alt="icona indirizzo" data-v-1497b166><input${ssrRenderAttr("value", $data.form.address)} type="text" id="address" placeholder="Indirizzo" required aria-required="true" aria-describedby="addressHelp" data-v-1497b166><small id="addressHelp" data-v-1497b166>Inserisci l&#39;indirizzo di consegna</small></div><div class="form-group" data-v-1497b166><label for="deliveryDate" aria-label="Data e Ora di Consegna" data-v-1497b166>Data e Ora*</label><img${ssrRenderAttr("src", _imports_2)} alt="icona data e ora" data-v-1497b166><input${ssrRenderAttr("value", $data.form.deliveryDate)} type="datetime-local" id="deliveryDate" required aria-required="true" aria-describedby="deliveryDateHelp" class="input-date" data-v-1497b166><small id="deliveryDateHelp" data-v-1497b166>Scegli la data e l&#39;orario di consegna</small></div><div class="form-group" data-v-1497b166><label for="email" aria-label="Email" data-v-1497b166>Email*</label><img${ssrRenderAttr("src", _imports_2$1)} alt="icona email" data-v-1497b166><input${ssrRenderAttr("value", $data.form.email)} type="email" id="email" placeholder="Email" required aria-required="true" aria-describedby="emailHelp" data-v-1497b166><small id="emailHelp" data-v-1497b166>Inserisci il tuo indirizzo email</small></div><div class="form-group" data-v-1497b166><label for="phone" aria-label="Numero di Telefono" data-v-1497b166>Numero di Telefono*</label><img${ssrRenderAttr("src", _imports_4)} alt="icona telefono" data-v-1497b166><input${ssrRenderAttr("value", $data.form.phone)} type="tel" id="phone" placeholder="Numero di telefono" required aria-required="true" aria-describedby="phoneHelp" data-v-1497b166><small id="phoneHelp" data-v-1497b166>Inserisci il tuo numero di telefono</small></div><div class="form-group" data-v-1497b166><label for="additionalInfo" aria-label="Informazioni Aggiuntive" data-v-1497b166>Informazioni Aggiuntive</label><img${ssrRenderAttr("src", _imports_3)} alt="icona nome e cognome" data-v-1497b166><textarea id="additionalInfo" placeholder="Altre info" aria-describedby="additionalInfoHelp" data-v-1497b166>${ssrInterpolate($data.form.additionalInfo)}</textarea><small id="additionalInfoHelp" data-v-1497b166>Aggiungi eventuali informazioni aggiuntive</small></div><div class="form-group terms" data-v-1497b166><label data-v-1497b166><input${ssrIncludeBooleanAttr(Array.isArray($data.form.acceptTerms) ? ssrLooseContain($data.form.acceptTerms, null) : $data.form.acceptTerms) ? " checked" : ""} type="checkbox" required aria-required="true" data-v-1497b166> Accetto i <a href="/terms" aria-label="Termini e condizioni" data-v-1497b166>termini e condizioni</a></label></div></div><div class="form-group" data-v-1497b166><h3 class="title-list" data-v-1497b166>Riepilogo Spesa</h3>`);
  _push(ssrRenderComponent(_component_ListCartComponent, { cartActions: false }, null, _parent));
  _push(`</div><div class="btn-send-list" data-v-1497b166>`);
  if (!$options.validateForm()) {
    _push(`<small class="error-text" data-v-1497b166>Compila i campi obbligatori</small>`);
  } else {
    _push(`<!---->`);
  }
...
const checkout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1497b166"]]);

export { checkout as default };
//# sourceMappingURL=checkout-CMJnADSK.mjs.map
