...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-446ed52d><div class="categories-container" data-v-446ed52d><button class="${ssrRenderClass([{ "btn-selected": !_ctx.categoryStore.selectedCategory }, "btn"])}" data-v-446ed52d>${ssrInterpolate(_ctx.categoryStore.selectedCategory ? "\u2190 Indietro" : "TUTTI")}</button><!--[-->`);
  ssrRenderList(_ctx.displayedCategories, (item) => {
    _push(`<button class="${ssrRenderClass([{ "btn-selected": _ctx.isSelected(item) }, "btn"])}" data-v-446ed52d>${ssrInterpolate(item)}</button>`);
  });
  _push(`<!--]--></div></div>`);
}
...
const PillowCategories = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-446ed52d"]]);
const _sfc_main$3 = {
  name: "HeaderSearch",
  components: {
    Logo,
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-a02eb93c><div class="list-product-container" data-v-a02eb93c><ul data-v-a02eb93c><!--[-->`);
  ssrRenderList(_ctx.filteredProducts, (product) => {
    _push(`<li class="product-item" data-v-a02eb93c>`);
    _push(ssrRenderComponent(_component_router_link, {
      to: `/product/${product.id}`
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="row-item" data-v-a02eb93c${_scopeId}>${ssrInterpolate(product.name)} `);
          if (product.vigneto) {
            _push2(`<span data-v-a02eb93c${_scopeId}> - ${ssrInterpolate(product.vigneto)}</span>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div><div class="row-item" data-v-a02eb93c${_scopeId}>`);
          if (product.annata) {
            _push2(`<span data-v-a02eb93c${_scopeId}>${ssrInterpolate(product.annata)}</span>`);
          } else {
            _push2(`<!---->`);
          }
          if (product.annata && product.grado_alcolico) {
            _push2(`<span data-v-a02eb93c${_scopeId}> - </span>`);
          } else {
            _push2(`<!---->`);
          }
          if (product.grado_alcolico) {
            _push2(`<span data-v-a02eb93c${_scopeId}>${ssrInterpolate(product.grado_alcolico)}% vol. </span>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
    ...
    _push(`<div class="row-item" data-v-a02eb93c><span class="row-item" data-v-a02eb93c><img class="icon-price"${ssrRenderAttr("src", _imports_1$1)} alt="icona che indica il prezzo" data-v-a02eb93c> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-a02eb93c><span data-v-a02eb93c>-</span><span data-v-a02eb93c><input type="number"${ssrRenderAttr("value", _ctx.getQuantity(product))} class="input-quantity" data-v-a02eb93c></span><span data-v-a02eb93c>+</span></span></div></li>`);
  });
  _push(`<!--]--></ul></div></div>`);
}
...
const ListProduct = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-a02eb93c"]]);
const _sfc_main = {
  name: "home",
  components: {
...
//# sourceMappingURL=index-34gU0qaF.mjs.map
