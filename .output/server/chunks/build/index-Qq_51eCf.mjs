...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-b7259f41><div class="categories-container" data-v-b7259f41><button class="${ssrRenderClass([{ "btn-selected": !_ctx.categoryStore.selectedCategory }, "btn"])}" data-v-b7259f41>${ssrInterpolate(_ctx.categoryStore.selectedCategory ? "\u2190 Indietro" : "TUTTI")}</button><!--[-->`);
  ssrRenderList(_ctx.displayedCategories, (item) => {
    _push(`<button class="${ssrRenderClass([{ "btn-selected": _ctx.isSelected(item) }, "btn"])}" data-v-b7259f41>${ssrInterpolate(item)}</button>`);
  });
  _push(`<!--]--></div></div>`);
}
...
const PillowCategories = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-b7259f41"]]);
const _sfc_main$3 = {
  name: "HeaderSearch",
  components: {
    Logo,
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-d287a70d><div class="list-product-container" data-v-d287a70d><ul data-v-d287a70d><!--[-->`);
  ssrRenderList(_ctx.filteredProducts, (product) => {
    _push(`<li class="product-item" data-v-d287a70d>`);
    _push(ssrRenderComponent(_component_router_link, {
      to: `/product/${product.id}`
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="row-item" data-v-d287a70d${_scopeId}>${ssrInterpolate(product.name)} `);
          if (product.vigneto) {
            _push2(`<span data-v-d287a70d${_scopeId}> - ${ssrInterpolate(product.vigneto)}</span>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div><div class="row-item" data-v-d287a70d${_scopeId}>`);
          if (product.annata) {
            _push2(`<span data-v-d287a70d${_scopeId}>${ssrInterpolate(product.annata)}</span>`);
          } else {
            _push2(`<!---->`);
          }
          if (product.annata && product.grado_alcolico) {
            _push2(`<span data-v-d287a70d${_scopeId}> - </span>`);
          } else {
            _push2(`<!---->`);
          }
          if (product.grado_alcolico) {
            _push2(`<span data-v-d287a70d${_scopeId}>${ssrInterpolate(product.grado_alcolico)}% vol. </span>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
    ...
    _push(`<div class="row-item" data-v-d287a70d><span class="row-item" data-v-d287a70d><img class="icon-price"${ssrRenderAttr("src", _imports_1$1)} alt="icona che indica il prezzo" data-v-d287a70d> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-d287a70d><span data-v-d287a70d>-</span><span data-v-d287a70d><input type="number"${ssrRenderAttr("value", _ctx.getQuantity(product))} class="input-quantity" data-v-d287a70d></span><span data-v-d287a70d>+</span></span></div></li>`);
  });
  _push(`<!--]--></ul></div></div>`);
}
...
const ListProduct = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-d287a70d"]]);
const _sfc_main = {
  name: "home",
  components: {
...
//# sourceMappingURL=index-Qq_51eCf.mjs.map
