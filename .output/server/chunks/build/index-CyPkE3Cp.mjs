...
import { u as useProductStore, a as useCategoryStore, _ as _imports_0$2 } from './back_red-BS0IKahS.mjs';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-f1ea2adc><button class="btn-filter" data-v-f1ea2adc><img${ssrRenderAttr("src", _imports_0)} class="icon-filter" alt="Icona per aprire la pagina filtri" data-v-f1ea2adc></button>`);
      if (showFilter.value) {
        _push(`<div class="filter-container" data-v-f1ea2adc><div class="filter-header" data-v-f1ea2adc><img${ssrRenderAttr("src", _imports_1)} alt="icona per chiudere la pagina filtri" class="icon-close" data-v-f1ea2adc><div class="filter-header-content" data-v-f1ea2adc><h2 class="filter-header-title" data-v-f1ea2adc>Filtri</h2><div class="filter-header-buttons" data-v-f1ea2adc><button class="btn apply" data-v-f1ea2adc>Applica filtri</button><button class="btn reset" data-v-f1ea2adc>Reset</button></div></div></div><div class="filter-content" data-v-f1ea2adc>`);
        _push(ssrRenderComponent(PillowFilter, { title: "Ordina per" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button id="abc" class="${ssrRenderClass([{ active: activeOrders.value.abc }, "btn mono"])}" data-v-f1ea2adc${_scopeId}> Alfabetico </button><button id="crescent" class="${ssrRenderClass([{ active: activeOrders.value.priceDesc }, "btn mono"])}" data-v-f1ea2adc${_scopeId}> Prezzo decrescente </button><button id="decrescent" class="${ssrRenderClass([{ active: activeOrders.value.priceAsc }, "btn mono"])}" data-v-f1ea2adc${_scopeId}> Prezzo crescente </button>`);
            } else {
              return [
                createVNode("button", {
                  id: "abc",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedColors.value, (color) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.subcategory.includes(color) }, "btn"])}" data-v-f1ea2adc${_scopeId}>${ssrInterpolate(color.replace("VINI ", ""))}</button>`);
              });
              _push2(`<!--]-->`);
              if (uniqueColors.value.length > INITIAL_DISPLAY) {
                _push2(`<div class="filter-controls" data-v-f1ea2adc${_scopeId}>`);
                if (uniqueColors.value.length > displayLimits.value.subcategory) {
                  _push2(`<div class="show-toggle" data-v-f1ea2adc${_scopeId}> Mostra di pi\xF9 </div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (displayLimits.value.subcategory > INITIAL_DISPLAY && uniqueColors.value.length > INITIAL_DISPLAY) {
                  _push2(`<div class="show-toggle" data-v-f1ea2adc${_scopeId}> Mostra meno </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedOrigins.value, (origin) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.origin.includes(origin) }, "btn"])}" data-v-f1ea2adc${_scopeId}>${ssrInterpolate(origin)}</button>`);
              });
              _push2(`<!--]-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedGrapes.value, (grape) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.grape.includes(grape) }, "btn"])}" data-v-f1ea2adc${_scopeId}>${ssrInterpolate(grape)}</button>`);
              });
              _push2(`<!--]-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedVintages.value, (vintage) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.vintage.includes(vintage) }, "btn"])}" data-v-f1ea2adc${_scopeId}>${ssrInterpolate(vintage)}</button>`);
              });
              _push2(`<!--]-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f1ea2adc"]]);
const _sfc_main$2 = {
  name: "BannerCategory",
  components: {
...
//# sourceMappingURL=index-CyPkE3Cp.mjs.map
