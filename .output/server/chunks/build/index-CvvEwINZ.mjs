...
import { u as useProductStore, _ as _imports_0$1 } from './back_red-D1A1AY7d.mjs';
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "search-bar-container" }, _attrs))} data-v-e4182c1f><img${ssrRenderAttr("src", _imports_0)} alt="icona lente che indica la ricerca testuale" class="search-text-icon" data-v-e4182c1f><input${ssrRenderAttr("value", _ctx.searchQuery)} aria-label="barra di ricerca dei prodotti" type="text" placeholder="Cerca" class="search-bar" id="search-bar" data-v-e4182c1f><button class="voice-search" data-v-e4182c1f><img${ssrRenderAttr("src", _imports_1)} alt="icona microfono che indica la ricerca vocale" data-v-e4182c1f></button></div>`);
}
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-6fae7415><div class="categories-container" data-v-6fae7415><button class="${ssrRenderClass([{ "btn-selected": !_ctx.categoryStore.selectedCategory }, "btn"])}" data-v-6fae7415>`);
  if (_ctx.categoryStore.selectedCategory) {
    _push(`<img${ssrRenderAttr("src", _imports_0$1)} alt="Indietro" data-v-6fae7415>`);
  } else {
    _push(`<!--[--> TUTTI <!--]-->`);
  }
  _push(`</button><!--[-->`);
  ssrRenderList(_ctx.displayedCategories, (item) => {
    _push(`<button class="${ssrRenderClass([{ "btn-selected": _ctx.isSelected(item) }, "btn"])}" data-v-6fae7415>${ssrInterpolate(item["category"].name)}</button>`);
  });
  _push(`<!--]--></div></div>`);
}
...
const PillowCategories = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-6fae7415"]]);
const _sfc_main$3 = {
  name: "HeaderSearch",
  components: {
    Logo,
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<h1${ssrRenderAttrs(mergeProps({ class: "intestate-category" }, _attrs))} data-v-357d4d2c>${ssrInterpolate($setup.categoryStore.selectedCategory ? $setup.categoryStore.selectedCategory["category"].name : "Tutti")}</h1>`);
}
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-357d4d2c"]]);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-ababe088><div class="list-product-container" data-v-ababe088><ul data-v-ababe088><!--[-->`);
  ssrRenderList(_ctx.filteredProducts, (product) => {
    _push(`<li class="product-item" data-v-ababe088>`);
    _push(ssrRenderComponent(_component_router_link, {
      to: `/product/${product.id}`
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="row-item" data-v-ababe088${_scopeId}>${ssrInterpolate(product.name)} `);
          if (product.vigneto) {
            _push2(`<span data-v-ababe088${_scopeId}> - ${ssrInterpolate(product.vigneto)}</span>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div><div class="row-item" data-v-ababe088${_scopeId}>`);
          if (product.annata) {
            _push2(`<span data-v-ababe088${_scopeId}>${ssrInterpolate(product.annata)}</span>`);
          } else {
            _push2(`<!---->`);
          }
          if (product.annata && product.grado_alcolico) {
            _push2(`<span data-v-ababe088${_scopeId}> - </span>`);
          } else {
            _push2(`<!---->`);
          }
          if (product.grado_alcolico) {
            _push2(`<span data-v-ababe088${_scopeId}>${ssrInterpolate(product.grado_alcolico)}% vol. </span>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div>`);
    ...
    _push(`<div class="row-item" data-v-ababe088><span class="row-item" data-v-ababe088><img class="icon-price"${ssrRenderAttr("src", _imports_2)} alt="icona che indica il prezzo" data-v-ababe088> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-ababe088><span data-v-ababe088>-</span><span data-v-ababe088><input type="number"${ssrRenderAttr("value", _ctx.getQuantity(product))} class="input-quantity" data-v-ababe088></span><span data-v-ababe088>+</span></span></div></li>`);
  });
  _push(`<!--]--></ul></div></div>`);
}
...
const ListProduct = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-ababe088"]]);
const _sfc_main = {
  name: "home",
  components: {
...
//# sourceMappingURL=index-CvvEwINZ.mjs.map
