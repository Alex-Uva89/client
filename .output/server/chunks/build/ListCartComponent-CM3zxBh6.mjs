  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cartTotal).toFixed(2) > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-cart" }, _attrs))} data-v-7426e129><ul class="list-product-container" data-v-7426e129><!--[-->`);
        ssrRenderList(unref(cartWithDetails), (product) => {
          _push(`<li class="product-item" data-v-7426e129>`);
          if (getQuantity(product) > 0) {
            _push(`<!--[--><div class="row-item" data-v-7426e129>${ssrInterpolate(product.name)} `);
            if (product.vigneto) {
              _push(`<span data-v-7426e129> - ${ssrInterpolate(product.vigneto)}</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="row-item" data-v-7426e129>`);
            if (product.annata) {
              _push(`<span data-v-7426e129>${ssrInterpolate(product.annata)}</span>`);
            } else {
              _push(`<!---->`);
            }
            if (product.annata && product.grado_alcolico) {
              _push(`<span data-v-7426e129> - </span>`);
            } else {
              _push(`<!---->`);
            }
            if (product.grado_alcolico) {
              _push(`<span data-v-7426e129>${ssrInterpolate(product.grado_alcolico)}% vol. </span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="row-item" data-v-7426e129><span class="row-item" data-v-7426e129><img class="icon-price"${ssrRenderAttr("src", _imports_2)} alt="icona che indica il prezzo" data-v-7426e129> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-7426e129><span data-v-7426e129>-</span><span data-v-7426e129><input type="number"${ssrRenderAttr("value", getQuantity(product))} class="input-quantity" data-v-7426e129></span><span data-v-7426e129>+</span></span></div><span data-v-7426e129><img class="icon-delete"${ssrRenderAttr("src", _imports_1)} alt="icona che indica la rimozione del prodotto totale dal carrello" data-v-7426e129></span><!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</li>`);
        });
        _push(`<!--]--></ul><div class="cart-total-container" data-v-7426e129><div class="cart-total" data-v-7426e129><span data-v-7426e129>Subtotale: </span><span data-v-7426e129>\u20AC${ssrInterpolate(unref(cartTotal).toFixed(2))}</span></div>`);
        if (__props.cartActions) {
          _push(`<div class="cart-actions" data-v-7426e129>`);
              ...
              if (_push2) {
                _push2(ssrRenderComponent(ButtonComponent, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-7426e129${_scopeId2}>Procedi all&#39;acquisto</span>`);
                    } else {
                      return [
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(ButtonComponent, { color: "var(--primary)" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-7426e129${_scopeId2}>Aggiungi altro al carrello</span>`);
                    } else {
                      return [
        ...
        if (isModalOpen.value) {
          _push(`<div class="modal-overlay" data-v-7426e129><div class="modal-content" data-v-7426e129><p data-v-7426e129> Sei sicuro di voler rimuovere tutte le unit\xE0 ( ${ssrInterpolate(productToDelete.value.quantity)} ) di &quot;${ssrInterpolate(productToDelete.value.name)}&quot; dal carrello? </p><div class="modal-buttons" data-v-7426e129><button data-v-7426e129>Conferma</button><button data-v-7426e129>Annulla</button></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7426e129"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=ListCartComponent-CM3zxBh6.mjs.map
