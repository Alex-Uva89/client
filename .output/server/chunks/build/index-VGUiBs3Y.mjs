...
import { u as useProductStore, a as useCategoryStore, _ as _imports_0$2 } from './back_red-C417FG6y.mjs';
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-e7302c0a><div class="categories-container" data-v-e7302c0a><button class="${ssrRenderClass([{ "btn-selected": !_ctx.categoryStore.selectedCategory }, "btn"])}" data-v-e7302c0a>`);
  if (_ctx.categoryStore.selectedCategory) {
    _push(`<img${ssrRenderAttr("src", _imports_0$2)} alt="Indietro" data-v-e7302c0a>`);
  } else {
    _push(`<!--[--> TUTTI <!--]-->`);
  }
  _push(`</button><!--[-->`);
  ssrRenderList(_ctx.displayedCategories, (item) => {
    _push(`<button class="${ssrRenderClass([{ "btn-selected": _ctx.isSelected(item) }, "btn"])}" data-v-e7302c0a>${ssrInterpolate(item["category"].name)}</button>`);
  });
  _push(`<!--]--></div></div>`);
}
...
const PillowCategories = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-e7302c0a"]]);
const _sfc_main$6 = {
  name: "HeaderSearch",
  components: {
    Logo,
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-84d4f5a3><button class="btn-filter" data-v-84d4f5a3><img${ssrRenderAttr("src", _imports_0)} class="icon-filter" alt="Icona per aprire la pagina filtri" data-v-84d4f5a3></button>`);
      if (showFilter.value) {
        _push(`<div class="filter-container" data-v-84d4f5a3><div class="filter-header" data-v-84d4f5a3><img${ssrRenderAttr("src", _imports_1)} alt="icona per chiudere la pagina filtri" class="icon-close" data-v-84d4f5a3><div class="filter-header-content" data-v-84d4f5a3><h2 class="filter-header-title" data-v-84d4f5a3>Filtri</h2><div class="filter-header-buttons" data-v-84d4f5a3><button class="btn apply" data-v-84d4f5a3>Applica filtri</button><button class="btn reset" data-v-84d4f5a3>Reset</button></div></div></div><div class="filter-content" data-v-84d4f5a3>`);
        _push(ssrRenderComponent(PillowFilter, { title: "Ordina per" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button id="abc" class="${ssrRenderClass([{ active: activeOrders.value.abc }, "btn mono"])}" data-v-84d4f5a3${_scopeId}> Alfabetico </button><button id="crescent" class="${ssrRenderClass([{ active: activeOrders.value.priceDesc }, "btn mono"])}" data-v-84d4f5a3${_scopeId}> Prezzo decrescente </button><button id="decrescent" class="${ssrRenderClass([{ active: activeOrders.value.priceAsc }, "btn mono"])}" data-v-84d4f5a3${_scopeId}> Prezzo crescente </button>`);
            } else {
              return [
                createVNode("button", {
                  id: "abc",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedColors.value, (color) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.subcategory.includes(color) }, "btn"])}" data-v-84d4f5a3${_scopeId}>${ssrInterpolate(color.replace("VINI ", ""))}</button>`);
              });
              _push2(`<!--]-->`);
              if (uniqueColors.value.length > INITIAL_DISPLAY) {
                _push2(`<div class="filter-controls" data-v-84d4f5a3${_scopeId}>`);
                if (uniqueColors.value.length > displayLimits.value.subcategory) {
                  _push2(`<div class="show-toggle" data-v-84d4f5a3${_scopeId}> Mostra di pi\xF9 </div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (displayLimits.value.subcategory > INITIAL_DISPLAY && uniqueColors.value.length > INITIAL_DISPLAY) {
                  _push2(`<div class="show-toggle" data-v-84d4f5a3${_scopeId}> Mostra meno </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedOrigins.value, (origin) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.origin.includes(origin) }, "btn"])}" data-v-84d4f5a3${_scopeId}>${ssrInterpolate(origin)}</button>`);
              });
              _push2(`<!--]-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedGrapes.value, (grape) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.grape.includes(grape) }, "btn"])}" data-v-84d4f5a3${_scopeId}>${ssrInterpolate(grape)}</button>`);
              });
              _push2(`<!--]-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedVintages.value, (vintage) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.vintage.includes(vintage) }, "btn"])}" data-v-84d4f5a3${_scopeId}>${ssrInterpolate(vintage)}</button>`);
              });
              _push2(`<!--]-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-84d4f5a3"]]);
const _sfc_main$2 = {
  name: "BannerCategory",
  components: {
...
const _sfc_main$1 = defineComponent({
  ...
  setup() {
    ...
    const filteredProducts = computed(() => {
      ...
      if (productStore.activeFilters.subcategory.length > 0 || productStore.activeFilters.origin.length > 0 || productStore.activeFilters.grape.length > 0 || productStore.activeFilters.vintage.length > 0) {
        return [];
      }
      if (categoryStore.selectedCategory) {
        const selectedCategoryId = categoryStore.selectedCategory.category.id;
        const filteredByCategory = productStore.products.filter(
          (product) => product.category_id === selectedCategoryId
        );
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-b2d170a7><div class="list-product-header" data-v-b2d170a7> Prodotti: ${ssrInterpolate(_ctx.filteredProducts.length > 0 ? _ctx.filteredProducts.length : "Nessun prodotto")}</div><div class="list-product-container" data-v-b2d170a7>`);
  if (_ctx.filteredProducts.length > 0) {
    _push(`<ul data-v-b2d170a7><!--[-->`);
    ssrRenderList(_ctx.filteredProducts, (product) => {
      _push(`<li class="product-item" data-v-b2d170a7>`);
      _push(ssrRenderComponent(_component_router_link, {
        to: `/product/${product.id}`
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="row-item" data-v-b2d170a7${_scopeId}>${ssrInterpolate(product.name)} `);
            if (product.grape) {
              _push2(`<span data-v-b2d170a7${_scopeId}> - ${ssrInterpolate(product.grape)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="row-item" data-v-b2d170a7${_scopeId}>`);
            if (product.vintage) {
              _push2(`<span data-v-b2d170a7${_scopeId}>${ssrInterpolate(product.vintage)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (product.vintage && product.degrees) {
              _push2(`<span data-v-b2d170a7${_scopeId}> - </span>`);
            } else {
              _push2(`<!---->`);
            }
            if (product.degrees) {
              _push2(`<span data-v-b2d170a7${_scopeId}>${ssrInterpolate(product.degrees)}% vol. </span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
      ...
      _push(`<div class="row-item" data-v-b2d170a7><span class="row-item" data-v-b2d170a7><img class="icon-price"${ssrRenderAttr("src", _imports_2)} alt="icona che indica il prezzo" data-v-b2d170a7> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-b2d170a7><span data-v-b2d170a7>-</span><span data-v-b2d170a7><input type="number"${ssrRenderAttr("value", _ctx.getQuantity(product))} class="input-quantity" data-v-b2d170a7></span><span data-v-b2d170a7>+</span></span></div></li>`);
    });
    _push(`<!--]--></ul>`);
  } else {
    _push(`<!---->`);
...
const ListProduct = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-b2d170a7"]]);
const _sfc_main = {
  name: "home",
  components: {
...
//# sourceMappingURL=index-VGUiBs3Y.mjs.map
