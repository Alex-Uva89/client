...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-Csl5moSI.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-DfU3RbJD.mjs')
  },
  {
    name: "confirm",
    path: "/confirm",
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dl1avvZ7.mjs')
  },
  {
    name: "login",
    path: "/login",
  ...
  },
  {
    name: "menu",
    path: "/menu",
    component: () => import('./menu-BM_aqO2H.mjs')
  },
  {
    name: "product-id",
    path: "/product/:id()",
    component: () => import('./_id_-Baz7E7CT.mjs')
  }
];
