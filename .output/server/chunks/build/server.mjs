...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D8yTWH2C.mjs')
  },
  {
    name: "login",
    path: "/login",
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createVNode("img", {
            src: _imports_1,
            alt: "logo aziendale, raffigurante volto di mamma elvira"
          }),
          createVNode("span", null, "Menù")
        ];
      }
    }),
    _: 1
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-f541a9ba>`);
      if (showWhiteScreen.value) {
        _push(`<div class="white-screen" data-v-f541a9ba></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showLoadingImage.value) {
        _push(`<div class="loading-screen" data-v-f541a9ba><img${ssrRenderAttr("src", _imports_0)} alt="Loading" data-v-f541a9ba><h1 class="loading-title" data-v-f541a9ba>CAMBUSA</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const Start = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f541a9ba"]]);
const _sfc_main$2 = {
  components: {
    Start,
    defaultLayout,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-vFirj4AD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C001eaU0.mjs'));
