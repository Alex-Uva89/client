...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-BF9-D5eL.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-DIOy0kRU.mjs')
  },
  {
    name: "confirm",
    path: "/confirm",
    component: () => import('./confirm-CzLwkx9o.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "menu",
    path: "/menu",
    component: () => import('./menu-tm5mj7xu.mjs')
  },
  {
    name: "product-id",
    path: "/product/:id()",
    component: () => import('./_id_-BqzpfW7p.mjs')
  }
];
