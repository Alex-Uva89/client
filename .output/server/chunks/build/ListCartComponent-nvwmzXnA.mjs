...
import { _ as _imports_0 } from './price-C1Yc9WIB.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cartTotal).toFixed(2) > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-cart" }, _attrs))} data-v-138440ff><ul class="list-product-container" data-v-138440ff><!--[-->`);
        ssrRenderList(unref(cartWithDetails), (product) => {
          _push(`<li class="product-item" data-v-138440ff>`);
          if (getQuantity(product) > 0) {
            _push(`<!--[--><div class="row-item" data-v-138440ff>${ssrInterpolate(product.name)} `);
            if (product.vigneto) {
              _push(`<span data-v-138440ff> - ${ssrInterpolate(product.vigneto)}</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="row-item" data-v-138440ff>`);
            if (product.annata) {
              _push(`<span data-v-138440ff>${ssrInterpolate(product.annata)}</span>`);
            } else {
              _push(`<!---->`);
            }
            if (product.annata && product.grado_alcolico) {
              _push(`<span data-v-138440ff> - </span>`);
            } else {
              _push(`<!---->`);
            }
            if (product.grado_alcolico) {
              _push(`<span data-v-138440ff>${ssrInterpolate(product.grado_alcolico)}% vol. </span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="row-item" data-v-138440ff><span class="row-item" data-v-138440ff><img class="icon-price"${ssrRenderAttr("src", _imports_0)} alt="icona che indica il prezzo" data-v-138440ff> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-138440ff><span data-v-138440ff>-</span><span data-v-138440ff><input type="number"${ssrRenderAttr("value", getQuantity(product))} class="input-quantity" data-v-138440ff></span><span data-v-138440ff>+</span></span></div><span data-v-138440ff><img class="icon-delete"${ssrRenderAttr("src", _imports_1)} alt="icona che indica la rimozione del prodotto totale dal carrello" data-v-138440ff></span><!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</li>`);
        });
        _push(`<!--]--></ul><div class="cart-total-container" data-v-138440ff><div class="cart-total" data-v-138440ff><span data-v-138440ff>Subtotale: </span><span data-v-138440ff>\u20AC${ssrInterpolate(unref(cartTotal).toFixed(2))}</span></div>`);
        if (__props.cartActions) {
          _push(`<div class="cart-actions" data-v-138440ff>`);
          _push(ssrRenderComponent(_component_router_link, { to: "/" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(__nuxt_component_0, { color: "var(--background)" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-138440ff${_scopeId2}>Aggiungi altro al carrello</span>`);
                    } else {
                      return [
                ...
                return [
                  createVNode(__nuxt_component_0, { color: "var(--background)" }, {
                    default: withCtx(() => [
                      createVNode("span", null, "Aggiungi altro al carrello")
                    ]),
                    _: 1
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(__nuxt_component_0, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-138440ff${_scopeId2}>Procedi all&#39;acquisto</span>`);
                    } else {
                      return [
        ...
        if (isModalOpen.value) {
          _push(`<div class="modal-overlay" data-v-138440ff><div class="modal-content" data-v-138440ff><p data-v-138440ff> Sei sicuro di voler rimuovere tutte le unit\xE0 ( ${ssrInterpolate(productToDelete.value.quantity)} ) di &quot;${ssrInterpolate(productToDelete.value.name)}&quot; dal carrello? </p><div class="modal-buttons" data-v-138440ff><button data-v-138440ff>Conferma</button><button data-v-138440ff>Annulla</button></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-138440ff"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=ListCartComponent-nvwmzXnA.mjs.map
