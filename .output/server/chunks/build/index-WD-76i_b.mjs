...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-e25a2997><div class="list-product-container" data-v-e25a2997><ul data-v-e25a2997><!--[-->`);
  ssrRenderList(_ctx.filteredProducts, (product) => {
    _push(`<li class="product-item" data-v-e25a2997><div class="row-item" data-v-e25a2997>${ssrInterpolate(product.name)} `);
    if (product.vigneto) {
      _push(`<span data-v-e25a2997> - ${ssrInterpolate(product.vigneto)}</span>`);
    } else {
      _push(`<!---->`);
    }
    _push(`</div><div class="row-item" data-v-e25a2997>`);
    if (product.annata) {
      _push(`<span data-v-e25a2997>${ssrInterpolate(product.annata)}</span>`);
    } else {
      _push(`<!---->`);
    }
    if (product.annata && product.grado_alcolico) {
      _push(`<span data-v-e25a2997> - </span>`);
    } else {
      _push(`<!---->`);
    }
    if (product.grado_alcolico) {
      _push(`<span data-v-e25a2997>${ssrInterpolate(product.grado_alcolico)}% vol. </span>`);
    } else {
      _push(`<!---->`);
    }
    _push(`</div><div class="row-item" data-v-e25a2997><span class="row-item" data-v-e25a2997><img class="icon-price"${ssrRenderAttr("src", _imports_0$1)} alt="icona che indica il prezzo" data-v-e25a2997> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-e25a2997><span data-v-e25a2997>-</span><span data-v-e25a2997><input type="number"${ssrRenderAttr("value", _ctx.getQuantity(product))} class="input-quantity" data-v-e25a2997></span><span data-v-e25a2997>+</span></span></div></li>`);
  });
  _push(`<!--]--></ul></div></div>`);
}
...
const ListProduct = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-e25a2997"]]);
const _sfc_main = {
  name: "home",
  components: {
...
//# sourceMappingURL=index-WD-76i_b.mjs.map
