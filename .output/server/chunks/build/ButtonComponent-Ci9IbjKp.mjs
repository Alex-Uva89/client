...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-d908de05>`);
  if (!$props.isLink) {
    _push(`<button${ssrRenderAttr("type", $props.type)}${ssrIncludeBooleanAttr($props.disabled) ? " disabled" : ""} class="btn" style="${ssrRenderStyle({
      ...
      color: $props.color === "var(--primary)" ? "var(--label)" : "var(--primary)",
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d908de05"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=ButtonComponent-Ci9IbjKp.mjs.map
