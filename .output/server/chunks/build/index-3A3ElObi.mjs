...
import { u as useProductStore, a as useCategoryStore, _ as _imports_0$2 } from './back_red-CyKsN_pI.mjs';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-7e4f6ecd><button class="btn-filter" data-v-7e4f6ecd><img${ssrRenderAttr("src", _imports_0)} class="icon-filter" alt="Icona per aprire la pagina filtri" data-v-7e4f6ecd></button>`);
      if (showFilter.value) {
        _push(`<div class="filter-container" data-v-7e4f6ecd><div class="filter-header" data-v-7e4f6ecd><img${ssrRenderAttr("src", _imports_1)} alt="icona per chiudere la pagina filtri" class="icon-close" data-v-7e4f6ecd><div class="filter-header-content" data-v-7e4f6ecd><h2 class="filter-header-title" data-v-7e4f6ecd>Filtri</h2><div class="filter-header-buttons" data-v-7e4f6ecd><button class="btn apply" data-v-7e4f6ecd>Applica filtri</button><button class="btn reset" data-v-7e4f6ecd>Reset</button></div></div></div><div class="filter-content" data-v-7e4f6ecd>`);
        _push(ssrRenderComponent(PillowFilter, { title: "Ordina per" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button id="abc" class="${ssrRenderClass([{ active: activeOrders.value.abc }, "btn mono"])}" data-v-7e4f6ecd${_scopeId}> Alfabetico </button><button id="crescent" class="${ssrRenderClass([{ active: activeOrders.value.priceDesc }, "btn mono"])}" data-v-7e4f6ecd${_scopeId}> Prezzo decrescente </button><button id="decrescent" class="${ssrRenderClass([{ active: activeOrders.value.priceAsc }, "btn mono"])}" data-v-7e4f6ecd${_scopeId}> Prezzo crescente </button>`);
            } else {
              return [
                createVNode("button", {
                  id: "abc",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedColors.value, (color) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.subcategory.includes(color) }, "btn"])}" data-v-7e4f6ecd${_scopeId}>${ssrInterpolate(color.replace("VINI ", ""))}</button>`);
              });
              _push2(`<!--]-->`);
              if (uniqueColors.value.length > INITIAL_DISPLAY) {
                _push2(`<div class="filter-controls" data-v-7e4f6ecd${_scopeId}>`);
                if (uniqueColors.value.length > displayLimits.value.subcategory) {
                  _push2(`<div class="show-toggle" data-v-7e4f6ecd${_scopeId}> Mostra di pi\xF9 </div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (displayLimits.value.subcategory > INITIAL_DISPLAY && uniqueColors.value.length > INITIAL_DISPLAY) {
                  _push2(`<div class="show-toggle" data-v-7e4f6ecd${_scopeId}> Mostra meno </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedOrigins.value, (origin) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.origin.includes(origin) }, "btn"])}" data-v-7e4f6ecd${_scopeId}>${ssrInterpolate(origin)}</button>`);
              });
              _push2(`<!--]-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedGrapes.value, (grape) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.grape.includes(grape) }, "btn"])}" data-v-7e4f6ecd${_scopeId}>${ssrInterpolate(grape)}</button>`);
              });
              _push2(`<!--]-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedVintages.value, (vintage) => {
                _push2(`<button class="${ssrRenderClass([{ active: tempFilters.value.vintage.includes(vintage) }, "btn"])}" data-v-7e4f6ecd${_scopeId}>${ssrInterpolate(vintage)}</button>`);
              });
              _push2(`<!--]-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-7e4f6ecd"]]);
const _sfc_main$2 = {
  name: "BannerCategory",
  components: {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-a8e8053c><div class="list-product-header" data-v-a8e8053c> Prodotti: ${ssrInterpolate(_ctx.filteredProducts.length > 0 ? _ctx.filteredProducts.length : "Nessun prodotto")}</div><div class="list-product-container" data-v-a8e8053c>`);
  if (_ctx.filteredProducts.length > 0) {
    _push(`<ul data-v-a8e8053c><!--[-->`);
    ssrRenderList(_ctx.filteredProducts, (product) => {
      _push(`<li class="product-item" data-v-a8e8053c>`);
      _push(ssrRenderComponent(_component_router_link, {
        to: `/product/${product.id}`
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="row-item" data-v-a8e8053c${_scopeId}>${ssrInterpolate(product.name)} `);
            if (product.grape) {
              _push2(`<span data-v-a8e8053c${_scopeId}> - ${ssrInterpolate(product.grape)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="row-item" data-v-a8e8053c${_scopeId}>`);
            if (product.vintage) {
              _push2(`<span data-v-a8e8053c${_scopeId}>${ssrInterpolate(product.vintage)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (product.vintage && product.degrees) {
              _push2(`<span data-v-a8e8053c${_scopeId}> - </span>`);
            } else {
              _push2(`<!---->`);
            }
            if (product.degrees) {
              _push2(`<span data-v-a8e8053c${_scopeId}>${ssrInterpolate(product.degrees)}% vol. </span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
      ...
      _push(`<div class="row-item" data-v-a8e8053c><span class="row-item" data-v-a8e8053c><img class="icon-price"${ssrRenderAttr("src", _imports_2)} alt="icona che indica il prezzo" data-v-a8e8053c> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-a8e8053c><span data-v-a8e8053c>-</span><span data-v-a8e8053c><input type="number"${ssrRenderAttr("value", _ctx.getQuantity(product))} class="input-quantity" data-v-a8e8053c></span><span data-v-a8e8053c>+</span></span></div></li>`);
    });
    _push(`<!--]--></ul>`);
  } else {
    _push(`<!---->`);
...
const ListProduct = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-a8e8053c"]]);
const _sfc_main = {
  name: "home",
  components: {
...
//# sourceMappingURL=index-3A3ElObi.mjs.map
