  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cartTotal).toFixed(2) > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-cart" }, _attrs))} data-v-b3f5903b><ul class="list-product-container" data-v-b3f5903b><!--[-->`);
        ssrRenderList(unref(cartWithDetails), (product) => {
          _push(`<li class="product-item" data-v-b3f5903b>`);
          if (getQuantity(product) > 0) {
            _push(`<!--[--><div class="row-item" data-v-b3f5903b>${ssrInterpolate(product.name)} `);
            if (product.vigneto) {
              _push(`<span data-v-b3f5903b> - ${ssrInterpolate(product.vigneto)}</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="row-item" data-v-b3f5903b>`);
            if (product.annata) {
              _push(`<span data-v-b3f5903b>${ssrInterpolate(product.annata)}</span>`);
            } else {
              _push(`<!---->`);
            }
            if (product.annata && product.grado_alcolico) {
              _push(`<span data-v-b3f5903b> - </span>`);
            } else {
              _push(`<!---->`);
            }
            if (product.grado_alcolico) {
              _push(`<span data-v-b3f5903b>${ssrInterpolate(product.grado_alcolico)}% vol. </span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="row-item" data-v-b3f5903b><span class="row-item" data-v-b3f5903b><img class="icon-price"${ssrRenderAttr("src", _imports_1$1)} alt="icona che indica il prezzo" data-v-b3f5903b> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-b3f5903b><span data-v-b3f5903b>-</span><span data-v-b3f5903b><input type="number"${ssrRenderAttr("value", getQuantity(product))} class="input-quantity" data-v-b3f5903b></span><span data-v-b3f5903b>+</span></span></div><span data-v-b3f5903b><img class="icon-delete"${ssrRenderAttr("src", _imports_1)} alt="icona che indica la rimozione del prodotto totale dal carrello" data-v-b3f5903b></span><!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</li>`);
        });
        _push(`<!--]--></ul><div class="cart-total-container" data-v-b3f5903b><div class="cart-total" data-v-b3f5903b><span data-v-b3f5903b>Subtotale: </span><span data-v-b3f5903b>\u20AC${ssrInterpolate(unref(cartTotal).toFixed(2))}</span></div>`);
        if (__props.cartActions) {
          _push(`<div class="cart-actions" data-v-b3f5903b>`);
              ...
              if (_push2) {
                _push2(ssrRenderComponent(ButtonComponent, { color: "var(--background)" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-b3f5903b${_scopeId2}>Aggiungi altro al carrello</span>`);
                    } else {
                      return [
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(ButtonComponent, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-b3f5903b${_scopeId2}>Procedi all&#39;acquisto</span>`);
                    } else {
                      return [
        ...
        if (isModalOpen.value) {
          _push(`<div class="modal-overlay" data-v-b3f5903b><div class="modal-content" data-v-b3f5903b><p data-v-b3f5903b> Sei sicuro di voler rimuovere tutte le unit\xE0 ( ${ssrInterpolate(productToDelete.value.quantity)} ) di &quot;${ssrInterpolate(productToDelete.value.name)}&quot; dal carrello? </p><div class="modal-buttons" data-v-b3f5903b><button data-v-b3f5903b>Conferma</button><button data-v-b3f5903b>Annulla</button></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b3f5903b"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=ListCartComponent-BtY-PrFy.mjs.map
