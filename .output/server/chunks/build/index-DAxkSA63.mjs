...
import { defineComponent, useSSRContext, computed, resolveComponent, mergeProps, ref, watch, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, createTextVNode } from 'vue';
import { u as useProductStore, _ as _imports_0$2 } from './back_red-DBgXPiVt.mjs';
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "filter-content-pillow" }, _attrs))} data-v-3d7b364e><h3 data-v-3d7b364e>${ssrInterpolate(__props.title)}</h3><div class="filter-content-order-buttons" data-v-3d7b364e>`);
...
const PillowFilter = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-3d7b364e"]]);
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emit = __emit;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "price-section" }, _attrs))} data-v-98cd2648><h3 class="range-title" data-v-98cd2648>Prezzo</h3><div class="dual-range-container" data-v-98cd2648><div class="range-slider" data-v-98cd2648><div class="slider-track" data-v-98cd2648></div><input type="range"${ssrRenderAttr("min", __props.min)}${ssrRenderAttr("max", __props.max)}${ssrRenderAttr("value", minValue.value)} class="range-input" data-v-98cd2648><input type="range"${ssrRenderAttr("min", __props.min)}${ssrRenderAttr("max", __props.max)}${ssrRenderAttr("value", maxValue.value)} class="range-input" data-v-98cd2648></div><div class="range-values" data-v-98cd2648><span data-v-98cd2648><p data-v-98cd2648>Min</p><div class="min-value" data-v-98cd2648>${ssrInterpolate(minValue.value)}</div></span><span data-v-98cd2648><p data-v-98cd2648>Max</p><div class="max-value" data-v-98cd2648>${ssrInterpolate(maxValue.value)}</div></span></div></div></div>`);
    };
  }
};
...
const RangeComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-98cd2648"]]);
...
const _sfc_main$3 = {
  ...
  setup(__props) {
      ...
      Object.entries(activeFilters.value).forEach(([filterType, values]) => {
        if (values.length > 0) {
          filteredProducts = filteredProducts.filter(
            (product) => values.includes(product[filterType])
          );
        }
      });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-0bf117a3><button class="btn-filter" data-v-0bf117a3><img${ssrRenderAttr("src", _imports_0)} class="icon-filter" alt="Icona per aprire la pagina filtri" data-v-0bf117a3></button>`);
      if (showFilter.value) {
        _push(`<div class="filter-container" data-v-0bf117a3><div class="filter-header" data-v-0bf117a3><img${ssrRenderAttr("src", _imports_1)} alt="icona per chiudere la pagina filtri" class="icon-close" data-v-0bf117a3><div class="filter-header-content" data-v-0bf117a3><h2 class="filter-header-title" data-v-0bf117a3>Filtri</h2><div class="filter-header-buttons" data-v-0bf117a3><button class="btn apply" data-v-0bf117a3>Applica filtri</button><button class="btn reset" data-v-0bf117a3>Reset</button></div></div></div><div class="filter-content" data-v-0bf117a3>`);
        _push(ssrRenderComponent(PillowFilter, { title: "Ordina per" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button id="abc" class="btn mono" data-v-0bf117a3${_scopeId}>Alfabetico</button><button id="crescent" class="btn mono" data-v-0bf117a3${_scopeId}>Prezzo decrescente</button><button id="decrescent" class="btn mono" data-v-0bf117a3${_scopeId}>Prezzo crescente</button>`);
            } else {
              return [
                createVNode("button", {
                  id: "abc",
                  class: "btn mono",
                  onClick: ($event) => _ctx.activeFilterMono()
                }, "Alfabetico", 8, ["onClick"]),
                createVNode("button", {
                  id: "crescent",
                  class: "btn mono",
                  onClick: ($event) => _ctx.activeFilterMono()
                }, "Prezzo decrescente", 8, ["onClick"]),
                createVNode("button", {
                  id: "decrescent",
                  class: "btn mono",
                  onClick: ($event) => _ctx.activeFilterMono()
                }, "Prezzo crescente", 8, ["onClick"])
              ];
            }
          }),
          _: 1
        ...
        _push(ssrRenderComponent(RangeComponent, {
          min: 0,
          max: 600,
          "onUpdate:values": _ctx.handleValues
        }, null, _parent));
        _push(ssrRenderComponent(PillowFilter, { title: "Colore" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<!--[-->`);
              ssrRenderList(displayedColors.value, (color) => {
                _push2(`<button class="${ssrRenderClass([{ active: activeFilters.value.subcategory.includes(color) }, "btn"])}" data-v-0bf117a3${_scopeId}>${ssrInterpolate(color)}</button>`);
              });
              _push2(`<!--]-->`);
              if (uniqueColors.value.length > INITIAL_DISPLAY) {
                _push2(`<div class="filter-controls" data-v-0bf117a3${_scopeId}>`);
                if (uniqueColors.value.length > displayLimits.value.subcategory) {
                  _push2(`<div class="show-toggle" data-v-0bf117a3${_scopeId}> Mostra di pi\xF9 </div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (displayLimits.value.subcategory > INITIAL_DISPLAY) {
                  _push2(`<div class="show-toggle" data-v-0bf117a3${_scopeId}> Mostra meno </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              ...
              return [
                (openBlock(true), createBlock(Fragment, null, renderList(displayedColors.value, (color) => {
                  return openBlock(), createBlock("button", {
                    key: color,
                    class: ["btn", { active: activeFilters.value.subcategory.includes(color) }],
                    onClick: ($event) => activeFilterMultiple(color, "subcategory")
                  }, toDisplayString(color), 11, ["onClick"]);
                }), 128)),
                uniqueColors.value.length > INITIAL_DISPLAY ? (openBlock(), createBlock("div", {
                  ...
                  displayLimits.value.subcategory > INITIAL_DISPLAY ? (openBlock(), createBlock("div", {
                    key: 1,
                    class: "show-toggle",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedOrigins.value, (origin) => {
                _push2(`<button class="${ssrRenderClass([{ active: activeFilters.value.origin.includes(origin) }, "btn"])}" data-v-0bf117a3${_scopeId}>${ssrInterpolate(origin)}</button>`);
              });
              _push2(`<!--]-->`);
              if (uniqueColors.value.length > INITIAL_DISPLAY) {
                _push2(`<div class="filter-controls" data-v-0bf117a3${_scopeId}>`);
              ...
              return [
                (openBlock(true), createBlock(Fragment, null, renderList(displayedOrigins.value, (origin) => {
                  return openBlock(), createBlock("button", {
                    key: origin,
                    class: ["btn", { active: activeFilters.value.origin.includes(origin) }],
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedGrapes.value, (grape) => {
                _push2(`<button class="${ssrRenderClass([{ active: activeFilters.value.grape.includes(grape) }, "btn"])}" data-v-0bf117a3${_scopeId}>${ssrInterpolate(grape)}</button>`);
              });
              _push2(`<!--]-->`);
              if (uniqueColors.value.length > INITIAL_DISPLAY) {
                _push2(`<div class="filter-controls" data-v-0bf117a3${_scopeId}>`);
              ...
              return [
                (openBlock(true), createBlock(Fragment, null, renderList(displayedGrapes.value, (grape) => {
                  return openBlock(), createBlock("button", {
                    key: grape,
                    class: ["btn", { active: activeFilters.value.grape.includes(grape) }],
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedVintages.value, (vintage) => {
                _push2(`<button class="${ssrRenderClass([{ active: activeFilters.value.vintage.includes(vintage) }, "btn"])}" data-v-0bf117a3${_scopeId}>${ssrInterpolate(vintage)}</button>`);
              });
              _push2(`<!--]-->`);
              if (uniqueColors.value.length > INITIAL_DISPLAY) {
                _push2(`<div class="filter-controls" data-v-0bf117a3${_scopeId}>`);
              ...
              return [
                (openBlock(true), createBlock(Fragment, null, renderList(displayedVintages.value, (vintage) => {
                  return openBlock(), createBlock("button", {
                    key: vintage,
                    class: ["btn", { active: activeFilters.value.vintage.includes(vintage) }],
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-0bf117a3"]]);
const _sfc_main$2 = {
  name: "BannerCategory",
  components: {
...
//# sourceMappingURL=index-DAxkSA63.mjs.map
