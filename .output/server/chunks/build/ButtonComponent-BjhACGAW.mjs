...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-8671cc0f>`);
  if (!$props.isLink) {
    _push(`<button${ssrRenderAttr("type", $props.type)}${ssrIncludeBooleanAttr($props.disabled) ? " disabled" : ""} class="btn" style="${ssrRenderStyle({
      width: $props.width,
      backgroundColor: !$props.disabled ? $props.color === "var(--primary)" ? "var(--background)" : "var(--primary)" : "var(--disabled)",
      color: !$props.disabled ? $props.color === "var(--primary)" ? "var(--primary)" : "var(--label)" : "var(--text-secondary)",
      border: !$props.disabled ? $props.color === "var(--primary)" ? "1px solid var(--primary)" : "none" : "none",
...
const ButtonComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8671cc0f"]]);

export { ButtonComponent as B };
//# sourceMappingURL=ButtonComponent-BjhACGAW.mjs.map
