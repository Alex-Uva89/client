  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cartTotal).toFixed(2) > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-cart" }, _attrs))} data-v-65356453><ul class="list-product-container" data-v-65356453><!--[-->`);
        ssrRenderList(unref(cartWithDetails), (product) => {
          _push(`<li class="product-item" data-v-65356453><div class="row-item" data-v-65356453>${ssrInterpolate(product.name)} `);
          if (product.vigneto) {
            _push(`<span data-v-65356453> - ${ssrInterpolate(product.vigneto)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><div class="row-item" data-v-65356453>`);
          if (product.annata) {
            _push(`<span data-v-65356453>${ssrInterpolate(product.annata)}</span>`);
          } else {
            _push(`<!---->`);
          }
          if (product.annata && product.grado_alcolico) {
            _push(`<span data-v-65356453> - </span>`);
          } else {
            _push(`<!---->`);
          }
          if (product.grado_alcolico) {
            _push(`<span data-v-65356453>${ssrInterpolate(product.grado_alcolico)}% vol. </span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div><div class="row-item" data-v-65356453><span class="row-item" data-v-65356453><img class="icon-price"${ssrRenderAttr("src", _imports_0)} alt="icona che indica il prezzo" data-v-65356453> ${ssrInterpolate(product.price)}</span><span class="counter" data-v-65356453><span data-v-65356453>-</span><span data-v-65356453>${ssrInterpolate(getQuantity(product))}</span><span data-v-65356453>+</span></span></div><span data-v-65356453><img class="icon-delete"${ssrRenderAttr("src", _imports_1)} alt="icona che indica la rimozione del prodotto totale dal carrello" data-v-65356453></span></li>`);
        });
        _push(`<!--]--></ul><div class="cart-total-container" data-v-65356453><div class="cart-total" data-v-65356453><span data-v-65356453>Subtotale: </span><span data-v-65356453>\u20AC${ssrInterpolate(unref(cartTotal).toFixed(2))}</span></div>`);
        if (__props.cartActions) {
          _push(`<div class="cart-actions" data-v-65356453>`);
              ...
              if (_push2) {
                _push2(ssrRenderComponent(__nuxt_component_0, { color: "var(--background)" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-65356453${_scopeId2}>Aggiungi altro al carrello</span>`);
                    } else {
                      return [
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(__nuxt_component_0, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-65356453${_scopeId2}>Procedi all&#39;acquisto</span>`);
                    } else {
                      return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-65356453"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=ListCartComponent-C3PUTk61.mjs.map
