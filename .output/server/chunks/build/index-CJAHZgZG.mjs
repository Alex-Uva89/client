...
import { u as useProductStore, _ as _imports_0$2 } from './back_red-DAjlx7oV.mjs';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-b0f0284a><button class="btn-filter" data-v-b0f0284a><img${ssrRenderAttr("src", _imports_0)} class="icon-filter" alt="Icona per aprire la pagina filtri" data-v-b0f0284a></button>`);
      if (showFilter.value) {
        _push(`<div class="filter-container" data-v-b0f0284a><div class="filter-header" data-v-b0f0284a><img${ssrRenderAttr("src", _imports_1)} alt="icona per chiudere la pagina filtri" class="icon-close" data-v-b0f0284a><div class="filter-header-content" data-v-b0f0284a><h2 class="filter-header-title" data-v-b0f0284a>Filtri</h2><div class="filter-header-buttons" data-v-b0f0284a><button class="btn apply" data-v-b0f0284a>Applica filtri</button><button class="btn reset" data-v-b0f0284a>Reset</button></div></div></div><div class="filter-content" data-v-b0f0284a>`);
        _push(ssrRenderComponent(PillowFilter, { title: "Ordina per" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button id="abc" class="btn mono" data-v-b0f0284a${_scopeId}>Alfabetico</button><button id="crescent" class="btn mono" data-v-b0f0284a${_scopeId}>Prezzo decrescente</button><button id="decrescent" class="btn mono" data-v-b0f0284a${_scopeId}>Prezzo crescente</button>`);
            } else {
              return [
                createVNode("button", {
                  id: "abc",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedColors.value, (color) => {
                _push2(`<button class="${ssrRenderClass([{ active: activeFilters.value.subcategory.includes(color) }, "btn"])}" data-v-b0f0284a${_scopeId}>${ssrInterpolate(color.replace("VINI ", ""))}</button>`);
              });
              _push2(`<!--]-->`);
              if (uniqueColors.value.length > INITIAL_DISPLAY) {
                _push2(`<div class="filter-controls" data-v-b0f0284a${_scopeId}>`);
                if (uniqueColors.value.length > displayLimits.value.subcategory) {
                  _push2(`<div class="show-toggle" data-v-b0f0284a${_scopeId}> Mostra di pi\xF9 </div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (displayLimits.value.subcategory > INITIAL_DISPLAY && uniqueColors.value.length > INITIAL_DISPLAY) {
                  _push2(`<div class="show-toggle" data-v-b0f0284a${_scopeId}> Mostra meno </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedOrigins.value, (origin) => {
                _push2(`<button class="${ssrRenderClass([{ active: activeFilters.value.origin.includes(origin) }, "btn"])}" data-v-b0f0284a${_scopeId}>${ssrInterpolate(origin)}</button>`);
              });
              _push2(`<!--]-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedGrapes.value, (grape) => {
                _push2(`<button class="${ssrRenderClass([{ active: activeFilters.value.grape.includes(grape) }, "btn"])}" data-v-b0f0284a${_scopeId}>${ssrInterpolate(grape)}</button>`);
              });
              _push2(`<!--]-->`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(displayedVintages.value, (vintage) => {
                _push2(`<button class="${ssrRenderClass([{ active: activeFilters.value.vintage.includes(vintage) }, "btn"])}" data-v-b0f0284a${_scopeId}>${ssrInterpolate(vintage)}</button>`);
              });
              _push2(`<!--]-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b0f0284a"]]);
const _sfc_main$2 = {
  name: "BannerCategory",
  components: {
...
//# sourceMappingURL=index-CJAHZgZG.mjs.map
