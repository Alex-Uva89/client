...
import { u as useProductStore } from './productStore-DDHURPR3.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-product-page" }, _attrs))} data-v-833ed52b><div class="header-product" data-v-833ed52b>`);
      _push(ssrRenderComponent(_component_router_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="icona del tasto indietro" data-v-833ed52b${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<div class="img-container" data-v-833ed52b><img class="img-product"${ssrRenderAttr("src", unref(product).img)}${ssrRenderAttr("alt", unref(product).name)} data-v-833ed52b></div><button class="btn btn-primary" data-v-833ed52b> condividi </button></div><div class="card-content" data-v-833ed52b><h2 data-v-833ed52b>${ssrInterpolate(unref(product).name)} - produttore</h2><p data-v-833ed52b>${ssrInterpolate(unref(product).vigneto ? unref(product).vigneto : "vigneto N/A")} ${ssrInterpolate(unref(product).annata ? unref(product).annata : "anno N/A")} - ${ssrInterpolate(unref(product).grado_alcolico ? unref(product).grado_alcolico : "N/A")}% vol.</p><div class="info-container" data-v-833ed52b><div class="price" data-v-833ed52b><img${ssrRenderAttr("src", _imports_1)} alt="" class="icon" data-v-833ed52b><p data-v-833ed52b>${ssrInterpolate(unref(product).price)}</p></div><div class="format" data-v-833ed52b><img${ssrRenderAttr("src", _imports_2)} alt="" class="icon" data-v-833ed52b><p data-v-833ed52b>75cl</p></div></div><div class="container-actions" data-v-833ed52b><span class="counter" data-v-833ed52b><span data-v-833ed52b>-</span><span data-v-833ed52b><input type="number"${ssrRenderAttr("value", getQuantity(unref(product)))} class="input-quantity" data-v-833ed52b></span><span data-v-833ed52b>+</span></span>`);
      if (unref(product).status == "true") {
        _push(`<span data-v-833ed52b>`);
      ...
      _push(`</div></div><div class="container-status" data-v-833ed52b>`);
      if (unref(product).status == "true") {
        _push(`<div data-v-833ed52b><span class="green-ball" data-v-833ed52b></span><span data-v-833ed52b>disponibile</span></div>`);
      } else {
        _push(`<div data-v-833ed52b><span class="red-ball" data-v-833ed52b></span><span data-v-833ed52b>non disponibile</span></div>`);
      }
      _push(`</div><div class="container-accordion" data-v-833ed52b>`);
      ...
      if (unref(productStore).products.filter((p) => p.price < unref(product).price && p.category === unref(product).category)) {
        _push(`<div data-v-833ed52b><h3 class="title-other-products" data-v-833ed52b>Guarda Anche:</h3><ul class="other-products" data-v-833ed52b><!--[-->`);
        ssrRenderList(unref(productStore).products.filter((p) => p.price < unref(product).price && p.category === unref(product).category), (filteredProduct) => {
          _push(`<li class="card-other-products" data-v-833ed52b>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: "/product/" + filteredProduct.id
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<h2 data-v-833ed52b${_scopeId}>${ssrInterpolate(filteredProduct.name)} - produttore</h2><p data-v-833ed52b${_scopeId}>${ssrInterpolate(filteredProduct.vigneto ? filteredProduct.vigneto : "vigneto N/A")} ${ssrInterpolate(filteredProduct.annata ? filteredProduct.annata : "anno N/A")} - ${ssrInterpolate(filteredProduct.grado_alcolico ? filteredProduct.grado_alcolico : "N/A")}% vol.</p><div class="info-container" data-v-833ed52b${_scopeId}><div class="price" data-v-833ed52b${_scopeId}><img${ssrRenderAttr("src", _imports_1)} alt="" class="icon" data-v-833ed52b${_scopeId}><p data-v-833ed52b${_scopeId}>${ssrInterpolate(filteredProduct.price)}</p></div></div>`);
              } else {
                return [
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-833ed52b"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-BdqbW9Sw.mjs.map
