...
import { u as useProductStore, _ as _imports_0 } from './back_red-CzgO6fLr.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-product-page" }, _attrs))} data-v-c3afe6ed><div class="header-product" data-v-c3afe6ed>`);
      _push(ssrRenderComponent(_component_router_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="icona del tasto indietro" data-v-c3afe6ed${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<div class="img-container" data-v-c3afe6ed><img class="img-product"${ssrRenderAttr("src", unref(product).image)}${ssrRenderAttr("alt", unref(product).name)} data-v-c3afe6ed></div><button class="btn btn-primary" data-v-c3afe6ed><img${ssrRenderAttr("src", _imports_1)} alt="icona di condivisione" data-v-c3afe6ed></button></div><div class="card-content" data-v-c3afe6ed><h2 data-v-c3afe6ed>${ssrInterpolate(unref(product).name)} - produttore</h2><p data-v-c3afe6ed>${ssrInterpolate(unref(product).vigneto ? unref(product).vigneto : "vigneto N/A")} ${ssrInterpolate(unref(product).annata ? unref(product).annata : "anno N/A")} - ${ssrInterpolate(unref(product).grado_alcolico ? unref(product).grado_alcolico : "N/A")}% vol.</p><div class="info-container" data-v-c3afe6ed><div class="price" data-v-c3afe6ed><img${ssrRenderAttr("src", _imports_2)} alt="" class="icon" data-v-c3afe6ed><p data-v-c3afe6ed>${ssrInterpolate(unref(product).price)}</p></div><div class="format" data-v-c3afe6ed><img${ssrRenderAttr("src", _imports_3)} alt="" class="icon" data-v-c3afe6ed><p data-v-c3afe6ed>75cl</p></div></div><div class="container-actions" data-v-c3afe6ed><span class="counter" data-v-c3afe6ed><span data-v-c3afe6ed>-</span><span data-v-c3afe6ed><input type="number"${ssrRenderAttr("value", getQuantity(unref(product)))} class="input-quantity" data-v-c3afe6ed></span><span data-v-c3afe6ed>+</span></span>`);
      if (unref(product).status == "true") {
        _push(`<span data-v-c3afe6ed>`);
      ...
      _push(`</div></div><div class="container-status" data-v-c3afe6ed>`);
      if (unref(product).status == "true") {
        _push(`<div data-v-c3afe6ed><span class="green-ball" data-v-c3afe6ed></span><span data-v-c3afe6ed>disponibile</span></div>`);
      } else {
        _push(`<div data-v-c3afe6ed><span class="red-ball" data-v-c3afe6ed></span><span data-v-c3afe6ed>non disponibile</span></div>`);
      }
      _push(`</div><div class="container-accordion" data-v-c3afe6ed>`);
      if (unref(product).description) {
        _push(ssrRenderComponent(AccordionComponent, { title: "Descrizione" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p data-v-c3afe6ed${_scopeId}>${ssrInterpolate(unref(product).description)}</p>`);
            } else {
              return [
      ...
      if (unref(productStore).products.filter((p) => p.price < unref(product).price && p.category === unref(product).category)) {
        _push(`<div data-v-c3afe6ed><h3 class="title-other-products" data-v-c3afe6ed>Guarda Anche:</h3><ul class="other-products" data-v-c3afe6ed><!--[-->`);
        ssrRenderList(unref(productStore).products.filter((p) => p.price < unref(product).price && p.category === unref(product).category), (filteredProduct) => {
          _push(`<li class="card-other-products" data-v-c3afe6ed>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: "/product/" + filteredProduct.id
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<h2 data-v-c3afe6ed${_scopeId}>${ssrInterpolate(filteredProduct.name)} - produttore</h2><p data-v-c3afe6ed${_scopeId}>${ssrInterpolate(filteredProduct.vigneto ? filteredProduct.vigneto : "vigneto N/A")} ${ssrInterpolate(filteredProduct.annata ? filteredProduct.annata : "anno N/A")} - ${ssrInterpolate(filteredProduct.grado_alcolico ? filteredProduct.grado_alcolico : "N/A")}% vol.</p><div class="info-container" data-v-c3afe6ed${_scopeId}><div class="price" data-v-c3afe6ed${_scopeId}><img${ssrRenderAttr("src", _imports_2)} alt="" class="icon" data-v-c3afe6ed${_scopeId}><p data-v-c3afe6ed${_scopeId}>${ssrInterpolate(filteredProduct.price)}</p></div><span class="counter" data-v-c3afe6ed${_scopeId}><span data-v-c3afe6ed${_scopeId}>-</span><span data-v-c3afe6ed${_scopeId}><input type="number"${ssrRenderAttr("value", getQuantity(filteredProduct))} class="input-quantity" data-v-c3afe6ed${_scopeId}></span><span data-v-c3afe6ed${_scopeId}>+</span></span></div>`);
              } else {
                return [
      ...
      if (unref(isCopied)) {
        _push(`<div class="link-copied" data-v-c3afe6ed><p data-v-c3afe6ed>Link copiato negli appunti!</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c3afe6ed"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-BIrSTP39.mjs.map
