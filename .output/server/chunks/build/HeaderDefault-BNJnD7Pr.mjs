import { useSSRContext, unref, withCtx, createVNode, mergeProps } from 'vue';
...
const ButtonBack = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-c1d2ba13"]]);
const _sfc_main = {
  __name: "HeaderDefault",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(_attrs)} data-v-eca3f921>`);
      _push(ssrRenderComponent(ButtonBack, {
        onClick: ($event) => unref(router).back()
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="icona del tasto indietro" data-v-eca3f921${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<h1 data-v-eca3f921>${ssrInterpolate(__props.title)}</h1></header>`);
    };
  }
};
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-eca3f921"]]);

export { Header as H };
//# sourceMappingURL=HeaderDefault-BNJnD7Pr.mjs.map
