...
import { A as AccordionComponent } from './AccordionComponent-DFAenL51.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-1eab24bb><div class="container-fix-header" data-v-1eab24bb>`);
  _push(ssrRenderComponent(_component_Header, { title: "Men\xF9" }, null, _parent));
  _push(`</div><div class="menu-container" data-v-1eab24bb><div class="menu-main-container" data-v-1eab24bb><div class="accordion-container" data-v-1eab24bb><img${ssrRenderAttr("src", _imports_0)} alt="icona cestino della spesa" class="accordion-icon" data-v-1eab24bb>`);
  ...
  _push(`</div><div class="accordion-group-container" data-v-1eab24bb><div class="accordion-container" data-v-1eab24bb><img${ssrRenderAttr("src", _imports_1)} alt="iconsa pacco delivery" class="accordion-icon" data-v-1eab24bb>`);
  _push(ssrRenderComponent(_component_Accordion, {
    title: "Dove spediamo",
    hasInput: true,
    type: "text",
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span data-v-1eab24bb${_scopeId}> In Cambusa troverai un\u2019ampia selezione di vino, bevande e cibo di qualit\xE0. Offriamo servizio di consegna a domicilio presso la location del tuo soggiorno nel Salento. </span><span data-v-1eab24bb${_scopeId}> La consegna \xE8 gratuita per gli ordini superiori a 79 euro. </span><span data-v-1eab24bb${_scopeId}> Inserisci qui sotto un indirizzo valido e scopri se la tua zona \xE8 coperta dal nostro servizio. </span>`);
      } else {
        return [
  ...
  _push(`</div><div class="accordion-container" data-v-1eab24bb><img${ssrRenderAttr("src", _imports_2)} alt="" class="accordion-icon" data-v-1eab24bb>`);
  _push(ssrRenderComponent(_component_Accordion, {
    title: "Chi siamo",
    hasInput: false,
    isLink: false
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p data-v-1eab24bb${_scopeId}> Cambusa \xE8 un servizio di consegna a domicilio per il tuo soggiorno nel Salento. </p><p data-v-1eab24bb${_scopeId}> Hai in programma una festa o aperitivo a casa, in masseria o in villa? Ordina dall\u2019app Cambusa e ricevi comodamente tutta la spesa in tempi rapidissimi. </p><p data-v-1eab24bb${_scopeId}> Inserisci l\u2019indirizzo di consegna nella sezione <strong data-v-1eab24bb${_scopeId}>\u201CIndirizzi\u201D</strong> e verifica subito la copertura del nostro servizio (garantiamo la consegna in tutto il territorio salentino)! </p>`);
      } else {
        return [
  ...
  _push(`</div></div><div class="accordion-group-container" data-v-1eab24bb><div class="accordion-container" data-v-1eab24bb><img${ssrRenderAttr("src", _imports_3)} alt="" class="accordion-icon" data-v-1eab24bb>`);
  _push(ssrRenderComponent(_component_Accordion, {
    title: "Altre info",
    hasInput: false,
    isLink: false
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p data-v-1eab24bb${_scopeId}> La tua privacy \xE8 importante per noi. I dati che raccogliamo vengono utilizzati esclusivamente per: </p><ul class="list-info" data-v-1eab24bb${_scopeId}><li data-v-1eab24bb${_scopeId}> Analisi di mercato, al fine di migliorare i nostri servizi e offrirti un&#39;esperienza personalizzata. </li><li data-v-1eab24bb${_scopeId}> Ricordare le tue preferenze e fornirti un servizio pi\xF9 efficiente. </li><li data-v-1eab24bb${_scopeId}> Non condividiamo i tuoi dati con terze parti non autorizzate e li conserviamo in conformit\xE0 con le normative vigenti sulla protezione dei dati personali. </li></ul>`);
      } else {
        return [
  ...
  _push(`</div><div class="accordion-container" data-v-1eab24bb><img${ssrRenderAttr("src", _imports_4)} alt="" class="accordion-icon" data-v-1eab24bb>`);
  _push(ssrRenderComponent(_component_Accordion, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p data-v-1eab24bb${_scopeId}> Contattaci per qualsiasi dubbio riguardante ordini, disponibilit\xE0 e istruzioni di consegna. </p>`);
      } else {
        return [
  ...
  _push(`</div><div class="accordion-container" data-v-1eab24bb><img${ssrRenderAttr("src", _imports_5)} alt="" class="accordion-icon" data-v-1eab24bb>`);
  _push(ssrRenderComponent(_component_Accordion, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h2 data-v-1eab24bb${_scopeId}> Aiutaci a migliorare!! </h2><p data-v-1eab24bb${_scopeId}> Cosa ne pensi del servizio CAMBUSA e del funzionamento di questa app? </p><p data-v-1eab24bb${_scopeId}> Scrivici e segnala tutto quello che vuoi rispetto alla tua esperienza con noi. </p>`);
      } else {
        return [
  ...
  _push(`</div></div></div><div class="footer" data-v-1eab24bb>`);
...
const menu = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1eab24bb"]]);

export { menu as default };
//# sourceMappingURL=menu-tm5mj7xu.mjs.map
