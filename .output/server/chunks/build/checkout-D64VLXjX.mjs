...
import { _ as __nuxt_component_1 } from './ListCartComponent-C2GcWfXu.mjs';
...
import { _ as _imports_2$1, a as _imports_3 } from './privacy-DhEbvMoM.mjs';
import 'vue-router';
import './price-Bg9TE_-Z.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-4a693375>`);
  _push(ssrRenderComponent(_component_HeaderDefault, { title: "Checkout" }, null, _parent));
  _push(`<form class="checkout-form" aria-labelledby="formTitle" data-v-4a693375><div class="form-container" data-v-4a693375><div class="form-group" data-v-4a693375><label for="fullName" aria-label="Nome e Cognome" data-v-4a693375>Nome e Cognome*</label><img${ssrRenderAttr("src", _imports_0)} alt="icona nome e cognome" data-v-4a693375><input${ssrRenderAttr("value", $data.form.fullName)} type="text" id="fullName" placeholder="Nome e Cognome" required aria-required="true" aria-describedby="fullNameHelp" data-v-4a693375><small id="fullNameHelp" data-v-4a693375>Inserisci il tuo nome completo</small></div><div class="form-group" data-v-4a693375><label for="address" aria-label="Indirizzo di Consegna" data-v-4a693375>Indirizzo di Consegna*</label><img${ssrRenderAttr("src", _imports_1)} alt="icona indirizzo" data-v-4a693375><input${ssrRenderAttr("value", $data.form.address)} type="text" id="address" placeholder="Indirizzo" required aria-required="true" aria-describedby="addressHelp" data-v-4a693375><small id="addressHelp" data-v-4a693375>Inserisci l&#39;indirizzo di consegna</small></div><div class="form-group" data-v-4a693375><label for="deliveryDate" aria-label="Data e Ora di Consegna" data-v-4a693375>Data e Ora*</label><img${ssrRenderAttr("src", _imports_2)} alt="icona data e ora" data-v-4a693375><input${ssrRenderAttr("value", $data.form.deliveryDate)} type="datetime-local" id="deliveryDate" required aria-required="true" aria-describedby="deliveryDateHelp" class="input-date" data-v-4a693375><small id="deliveryDateHelp" data-v-4a693375>Scegli la data e l&#39;orario di consegna</small></div><div class="form-group" data-v-4a693375><label for="email" aria-label="Email" data-v-4a693375>Email*</label><img${ssrRenderAttr("src", _imports_2$1)} alt="icona email" data-v-4a693375><input${ssrRenderAttr("value", $data.form.email)} type="email" id="email" placeholder="Email" required aria-required="true" aria-describedby="emailHelp" data-v-4a693375><small id="emailHelp" data-v-4a693375>Inserisci il tuo indirizzo email</small></div><div class="form-group" data-v-4a693375><label for="phone" aria-label="Numero di Telefono" data-v-4a693375>Numero di Telefono*</label><img${ssrRenderAttr("src", _imports_4)} alt="icona telefono" data-v-4a693375><input${ssrRenderAttr("value", $data.form.phone)} type="tel" id="phone" placeholder="Numero di telefono" required aria-required="true" aria-describedby="phoneHelp" data-v-4a693375><small id="phoneHelp" data-v-4a693375>Inserisci il tuo numero di telefono</small></div><div class="form-group" data-v-4a693375><label for="additionalInfo" aria-label="Informazioni Aggiuntive" data-v-4a693375>Informazioni Aggiuntive</label><img${ssrRenderAttr("src", _imports_3)} alt="icona nome e cognome" data-v-4a693375><textarea id="additionalInfo" placeholder="Altre info" aria-describedby="additionalInfoHelp" data-v-4a693375>${ssrInterpolate($data.form.additionalInfo)}</textarea><small id="additionalInfoHelp" data-v-4a693375>Aggiungi eventuali informazioni aggiuntive</small></div><div class="form-group terms" data-v-4a693375><label data-v-4a693375><input${ssrIncludeBooleanAttr(Array.isArray($data.form.acceptTerms) ? ssrLooseContain($data.form.acceptTerms, null) : $data.form.acceptTerms) ? " checked" : ""} type="checkbox" required aria-required="true" data-v-4a693375> Accetto i <a href="/terms" aria-label="Termini e condizioni" data-v-4a693375>termini e condizioni</a></label></div></div><div class="form-group" data-v-4a693375><h3 class="title-list" data-v-4a693375>Riepilogo Spesa</h3>`);
  _push(ssrRenderComponent(_component_ListCartComponent, { cartActions: false }, null, _parent));
  _push(`</div><div class="btn-send-list" data-v-4a693375>`);
  if (!$options.validateForm()) {
    _push(`<small class="error-text" data-v-4a693375>Compila i campi obbligatori</small>`);
  } else {
    _push(`<!---->`);
  }
...
const checkout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4a693375"]]);

export { checkout as default };
//# sourceMappingURL=checkout-D64VLXjX.mjs.map
