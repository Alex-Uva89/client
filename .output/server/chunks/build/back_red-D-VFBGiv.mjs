...
const useProductStore = defineStore("product", {
  ...
  actions: {
    ...
    updateFilteredProducts() {
      ...
      this.filteredProductsState = !query ? this.products : this.products.filter(
        (product) => product.name.toLowerCase().includes(query)
      );
    },
    addToCart(productId) {
    ...
    // Filters
    orderByABC() {
      this.filteredProductsState = [...this.filteredProductsState].sort(
...
//# sourceMappingURL=back_red-D-VFBGiv.mjs.map
