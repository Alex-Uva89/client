...
import { u as useProductStore, _ as _imports_0 } from './back_red-BGlWKeWA.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-product-page" }, _attrs))} data-v-0d56b990><div class="header-product" data-v-0d56b990>`);
      _push(ssrRenderComponent(_component_router_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="icona del tasto indietro" data-v-0d56b990${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<div class="img-container" data-v-0d56b990><img class="img-product"${ssrRenderAttr("src", unref(product).img)}${ssrRenderAttr("alt", unref(product).name)} data-v-0d56b990></div><button class="btn btn-primary" data-v-0d56b990><img${ssrRenderAttr("src", _imports_1)} alt="icona di condivisione" data-v-0d56b990></button></div><div class="card-content" data-v-0d56b990><h2 data-v-0d56b990>${ssrInterpolate(unref(product).name)} - produttore</h2><p data-v-0d56b990>${ssrInterpolate(unref(product).vigneto ? unref(product).vigneto : "vigneto N/A")} ${ssrInterpolate(unref(product).annata ? unref(product).annata : "anno N/A")} - ${ssrInterpolate(unref(product).grado_alcolico ? unref(product).grado_alcolico : "N/A")}% vol.</p><div class="info-container" data-v-0d56b990><div class="price" data-v-0d56b990><img${ssrRenderAttr("src", _imports_2)} alt="" class="icon" data-v-0d56b990><p data-v-0d56b990>${ssrInterpolate(unref(product).price)}</p></div><div class="format" data-v-0d56b990><img${ssrRenderAttr("src", _imports_3)} alt="" class="icon" data-v-0d56b990><p data-v-0d56b990>75cl</p></div></div><div class="container-actions" data-v-0d56b990><span class="counter" data-v-0d56b990><span data-v-0d56b990>-</span><span data-v-0d56b990><input type="number"${ssrRenderAttr("value", getQuantity(unref(product)))} class="input-quantity" data-v-0d56b990></span><span data-v-0d56b990>+</span></span>`);
      if (unref(product).status == "true") {
        _push(`<span data-v-0d56b990>`);
      ...
      _push(`</div></div><div class="container-status" data-v-0d56b990>`);
      if (unref(product).status == "true") {
        _push(`<div data-v-0d56b990><span class="green-ball" data-v-0d56b990></span><span data-v-0d56b990>disponibile</span></div>`);
      } else {
        _push(`<div data-v-0d56b990><span class="red-ball" data-v-0d56b990></span><span data-v-0d56b990>non disponibile</span></div>`);
      }
      _push(`</div><div class="container-accordion" data-v-0d56b990>`);
      if (unref(product).description) {
        _push(ssrRenderComponent(AccordionComponent, { title: "Descrizione" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p data-v-0d56b990${_scopeId}>${ssrInterpolate(unref(product).description)}</p>`);
            } else {
              return [
      ...
      if (unref(productStore).products.filter((p) => p.price < unref(product).price && p.category === unref(product).category)) {
        _push(`<div data-v-0d56b990><h3 class="title-other-products" data-v-0d56b990>Guarda Anche:</h3><ul class="other-products" data-v-0d56b990><!--[-->`);
        ssrRenderList(unref(productStore).products.filter((p) => p.price < unref(product).price && p.category === unref(product).category), (filteredProduct) => {
          _push(`<li class="card-other-products" data-v-0d56b990>`);
          _push(ssrRenderComponent(_component_router_link, {
            to: "/product/" + filteredProduct.id
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<h2 data-v-0d56b990${_scopeId}>${ssrInterpolate(filteredProduct.name)} - produttore</h2><p data-v-0d56b990${_scopeId}>${ssrInterpolate(filteredProduct.vigneto ? filteredProduct.vigneto : "vigneto N/A")} ${ssrInterpolate(filteredProduct.annata ? filteredProduct.annata : "anno N/A")} - ${ssrInterpolate(filteredProduct.grado_alcolico ? filteredProduct.grado_alcolico : "N/A")}% vol.</p><div class="info-container" data-v-0d56b990${_scopeId}><div class="price" data-v-0d56b990${_scopeId}><img${ssrRenderAttr("src", _imports_2)} alt="" class="icon" data-v-0d56b990${_scopeId}><p data-v-0d56b990${_scopeId}>${ssrInterpolate(filteredProduct.price)}</p></div><span class="counter" data-v-0d56b990${_scopeId}><span data-v-0d56b990${_scopeId}>-</span><span data-v-0d56b990${_scopeId}><input type="number"${ssrRenderAttr("value", getQuantity(filteredProduct))} class="input-quantity" data-v-0d56b990${_scopeId}></span><span data-v-0d56b990${_scopeId}>+</span></span></div>`);
              } else {
                return [
      ...
      if (unref(isCopied)) {
        _push(`<div class="link-copied" data-v-0d56b990><p data-v-0d56b990>Link copiato negli appunti!</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=_id_-CHi2Mp0U.mjs.map
