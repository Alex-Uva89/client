...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-confirm" }, _attrs))} data-v-7ea182cb><img class="icon-confirm"${ssrRenderAttr("src", _imports_0)} alt="" data-v-7ea182cb><div class="container-dates" data-v-7ea182cb><div class="container-title" data-v-7ea182cb><h2 class="title-confirm" data-v-7ea182cb> La tua lista \xE8 stata inviata </h2><small data-v-7ea182cb>congratulazioni!</small></div><div class="banner-confirm" data-v-7ea182cb><span data-v-7ea182cb> Riceverai la conferma dell&#39;ordine all&#39;indirizzo email selezionato: </span><h3 data-v-7ea182cb>${ssrInterpolate($setup.orderData ? $setup.orderData.email : "N/A")}</h3></div><div data-v-7ea182cb><h3 data-v-7ea182cb> il tuo numero ordine: </h3><span data-v-7ea182cb>${ssrInterpolate($setup.orderNumber ? $setup.orderNumber : "N/A")}</span></div><div data-v-7ea182cb><h3 data-v-7ea182cb> riceverai la tua lista della spesa il: </h3><span data-v-7ea182cb>${ssrInterpolate($setup.orderData ? $setup.orderData.deliveryDate : "N/A")}</span></div><div data-v-7ea182cb><h3 data-v-7ea182cb> All&#39;indirizzo: </h3><span data-v-7ea182cb>${ssrInterpolate($setup.orderData ? $setup.orderData.address : "N/A")}</span></div><div data-v-7ea182cb><h3 data-v-7ea182cb> Totale da pagare alla consegna: </h3><span data-v-7ea182cb>${ssrInterpolate($setup.cartTotal ? $setup.cartTotal : "N/A")} \u20AC</span></div></div><div class="container-actions" data-v-7ea182cb>`);
...
const confirm = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7ea182cb"]]);

export { confirm as default };
//# sourceMappingURL=confirm-D3gcuX3S.mjs.map
