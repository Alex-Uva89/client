...
import { defineComponent, useSSRContext, computed, resolveComponent, ref, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode } from 'vue';
import { u as useProductStore, _ as _imports_0$2 } from './back_red-BlvYJxpW.mjs';
...
const SearcBar = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-e4182c1f"]]);
...
const PillowCategories = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-bd313e2c"]]);
const _sfc_main$4 = {
  name: "HeaderSearch",
  components: {
    Logo,
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-a3b152eb"]]);
const _sfc_main$3 = {
  name: "BannerCategory",
  setup() {
    const categoryStore = useCategoryStore();
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-0fbf7817"]]);
const _imports_0 = "" + buildAssetsURL("image 2.Eo2V3nLt.png");
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-56011307>`);
      if (showWhiteScreen.value) {
        _push(`<div class="white-screen" data-v-56011307></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showLoadingImage.value) {
        _push(`<div class="loading-screen" data-v-56011307><img${ssrRenderAttr("src", _imports_0)} alt="Loading" data-v-56011307>`);
        _push(ssrRenderComponent(Logo, { class: "loading-title" }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
...
const Start = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-56011307"]]);
...
//# sourceMappingURL=index-U9W3ZJWv.mjs.map
