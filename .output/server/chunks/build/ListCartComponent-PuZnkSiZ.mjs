  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cartTotal).toFixed(2) > 0) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "container-cart" }, _attrs))} data-v-3e89e2aa><ul class="list-product-container" data-v-3e89e2aa><!--[-->`);
        ssrRenderList(unref(cartWithDetails), (product) => {
          _push(`<li class="product-item" data-v-3e89e2aa>`);
          if (getQuantity(product) > 0) {
            _push(`<!--[--><div class="row-link" data-v-3e89e2aa><div class="row-item" data-v-3e89e2aa>${ssrInterpolate(product.name)} `);
            if (product.grape) {
              _push(`<span data-v-3e89e2aa> - ${ssrInterpolate(product.grape)}</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="row-item" data-v-3e89e2aa>`);
            if (product.vintage) {
              _push(`<span data-v-3e89e2aa>${ssrInterpolate(product.vintage)}</span>`);
            } else {
              _push(`<!---->`);
            }
            if (product.vintage && product.degrees) {
              _push(`<span data-v-3e89e2aa> - </span>`);
            } else {
              _push(`<!---->`);
            }
            if (product.degrees) {
              _push(`<span data-v-3e89e2aa>${ssrInterpolate(product.degrees)}% vol. </span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><span class="row-item" data-v-3e89e2aa><img class="icon-price"${ssrRenderAttr("src", _imports_2)} alt="icona che indica il prezzo" data-v-3e89e2aa> ${ssrInterpolate(product.price)}</span></div><div class="row-item actions" data-v-3e89e2aa><span data-v-3e89e2aa><img class="icon-delete"${ssrRenderAttr("src", _imports_1)} alt="icona che indica la rimozione del prodotto totale dal carrello" data-v-3e89e2aa></span><span class="counter" data-v-3e89e2aa><span data-v-3e89e2aa>-</span><span data-v-3e89e2aa><input type="number"${ssrRenderAttr("value", getQuantity(product))} class="input-quantity" data-v-3e89e2aa></span><span data-v-3e89e2aa>+</span></span></div><!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</li>`);
        });
        _push(`<!--]--></ul><div class="cart-total-container" data-v-3e89e2aa><div class="cart-total" data-v-3e89e2aa><span data-v-3e89e2aa>Subtotale: </span><span data-v-3e89e2aa>\u20AC${ssrInterpolate(unref(cartTotal).toFixed(2))}</span></div>`);
        if (__props.cartActions) {
          _push(`<div class="cart-actions" data-v-3e89e2aa>`);
              ...
              if (_push2) {
                _push2(ssrRenderComponent(ButtonComponent, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-3e89e2aa${_scopeId2}>Procedi all&#39;acquisto</span>`);
                    } else {
                      return [
          ...
          _push(ssrRenderComponent(_component_router_link, { to: "/" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(ButtonComponent, { color: "var(--primary)" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-3e89e2aa${_scopeId2}>Aggiungi altro al carrello</span>`);
                    } else {
                      return [
                ...
                return [
                  createVNode(ButtonComponent, { color: "var(--primary)" }, {
                    default: withCtx(() => [
                      createVNode("span", null, "Aggiungi altro al carrello")
                    ]),
                    _: 1
        ...
        if (isModalOpen.value) {
          _push(`<div class="modal-overlay" data-v-3e89e2aa><div class="modal-content" data-v-3e89e2aa><p data-v-3e89e2aa> Sei sicuro di voler rimuovere tutte le unit\xE0 ( ${ssrInterpolate(productToDelete.value.quantity)} ) di &quot;${ssrInterpolate(productToDelete.value.name)}&quot; dal carrello? </p><div class="modal-buttons" data-v-3e89e2aa><button data-v-3e89e2aa>Conferma</button><button data-v-3e89e2aa>Annulla</button></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3e89e2aa"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=ListCartComponent-PuZnkSiZ.mjs.map
